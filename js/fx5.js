  ...
  VE.STYLES.push(
    {
      ...
      fx: [
        ['cadencia', { fps: 18 }],
        ['blur', { rad: 1.1, mixv: 0.7 }],
        ['filmstock', { exp: 0.04, con: 0.02, sat: -0.12, temp: 0.2, tintg: -0.08, fade: 0.13, roll: 0.55, split: 0.55, shTint: '#3a2638', hiTint: '#f6ecb6', vig: 0.1, grain: 0, sharp: 0 }],
        ['filmgrain', { fmt: 1, amt: 0.13, shadow: 0.7, color: 0.1, suave: 0.45, fps: 18 }],
        ['dustscratch', { dust: 0.07, dustSize: 0.8, scratch: 0, hair: 0.03, fps: 12 }],
        ['gateweave', { amt: 0.07, spd: 1.2, rot: 0.05, jump: 0.06, jumpRate: 0.12 }],
        ['lightleak', { amt: 0.2, side: 0, width: 0.22, spd: 0.25, flick: 0.2, bloom: 0.7 }],
        ['filmgate', { fmt: 0, forma: 1, tam: 0.88, zoom: 1.0, soft: 0.01, round: 0.75, vig: 0.12, sombra: 0.55, sombraW: 0.09, flick: 0.08, flickHz: 18, weave: 0.06 }]
      ]
    },
    {
      ...
      fx: [
        ['cadencia', { fps: 18 }],
        ['blur', { rad: 0.8, mixv: 0.55 }],
        ['filmstock', { exp: 0.03, con: 0.06, sat: -0.04, temp: 0.24, tintg: -0.04, fade: 0.11, roll: 0.5, split: 0.45, shTint: '#33231c', hiTint: '#ffeac0', vig: 0.08, grain: 0, sharp: 0 }],
        ['filmgrain', { fmt: 2, amt: 0.11, shadow: 0.7, color: 0.1, suave: 0.45, fps: 18 }],
        ['dustscratch', { dust: 0.05, dustSize: 0.7, scratch: 0, hair: 0.02, fps: 12 }],
        ['gateweave', { amt: 0.05, spd: 1.1, rot: 0.04, jump: 0.05, jumpRate: 0.1 }],
        ['lightleak', { amt: 0.14, side: 0, width: 0.2, spd: 0.2, flick: 0.15, bloom: 0.7 }],
    ...
    },
    {
      ...
      fx: [
        ...
        ['filmgrain', { fmt: 3, amt: 0.1, shadow: 0.6, color: 0.08, suave: 0.5, fps: 24 }],
        ['gateweave', { amt: 0.03, spd: 1.0, rot: 0.02, jump: 0.03, jumpRate: 0.08 }],
